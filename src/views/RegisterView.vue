...
<template>
  ...
  <main>
    <!-- ===== SignIn Form Start ===== -->
    <section class="i pg fh rm ki xn vq hj rp hr bg-white">
      <!-- Bg Shapes -->
      <!-- <img src="../assets/images/shape-06.svg" alt="Shape" class="h j k" />
            <img src="../assets/images/shape-03.svg" alt="Shape" class="h l m" />
            <img src="../assets/images/shape-17.svg" alt="Shape" class="h n o" />
      ...
      <div class="flex items-center justify-center">
        <!-- Bg Border -->
        <div
          class="relative flex w-full  max-w-[85rem] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
          <div
            ...
            <img src="../assets/images/Rectangle 2756.png" alt="image" class="h-full w-full object-cover" />
          </div>
          <div class="p-6 lg:w-2/5 w-full">
            <div class="rj">
              <h2 class="ek ck kk wm xb text-orange-500">EATWHERE</h2>
              <p class="text-bold">Welcome to EATWHERE</p>
            </div>
            ...
            <form class="sb" action="" method="POST">
              ...
              <div class="wb">
                <label class="rc kk wm vb" for="cpassword">Confirm Password</label>
                <input type="password" name="cpassword" id="cpassword" placeholder="Enter Password"
                  class="vd hh rg zk _g ch hm dm fm pl/50 xi mi sm xm pm dn/40" />
              </div>
            ...
            <span class="i rc sj hk xj">
              ...
              <p class="text-center">Or, sign up with your email</p>
            </span>

            <h3 class="hk yj kk wm ob mc text-center">Sign up with Social Media</h3>
            <ul class="tc wf xf mg ec">
              <li>
            ...
            <p class="sj hk xj rj ob">
              Already have an account?
              <a class="mk" href="signup.html"> Sign in </a>
            </p>
          </div>
        </div>
      </div>
