  ...
  <main>
    ...
    <section class="gj do ir hj sp jr i pg">
      ...
      <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
        <img
          src="/src/assets/images/shape-01.svg"
          alt="shape"
          class="xc 2xl:ud-block h t -ud-left-[10%] ua"
        />
        <img
          src="/src/assets/images/shape-02.svg"
          alt="shape"
          class="xc 2xl:ud-block h u p va"
        />
        <img
          src="/src/assets/images/shape-03.svg"
          alt="shape"
          class="xc 2xl:ud-block h v w va"
        />
        <img src="/src/assets/images/shape-04.svg" alt="shape" class="h q r" />
        <img src="/src/assets/images/hero.png" alt="Woman" class="h q r ua" />
      </div>
    ...
    <section class="i pg ji gp uq">
      ...
      <img src="/src/assets/images/shape-08.svg" alt="Shape Bg" class="h q r" />
      <img
        src="/src/assets/images/shape-09.svg"
        alt="Shape"
        class="of h y z/2"
      />
      <img src="/src/assets/images/shape-10.svg" alt="Shape" class="h _ aa" />
      <img
        ...
        <div class="wc qf pn xo gg cp">
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="/src/assets/images/team-01.png" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="/src/assets/images/team-02.png" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="/src/assets/images/team-03.png" alt="Team" />
    ...
    <section x-data="setup()" class="i pg fh rm ji gp uq">
      <!-- Bg Shapes -->
      <img src="/src/assets/images/shape-06.svg" alt="Shape" class="h aa y" />
      <img src="/src/assets/images/shape-03.svg" alt="Shape" class="h ca u" />
      <img
        src="/src/assets/images/shape-07.svg"
        alt="Shape"
        class="h w da ee"
      />
      <img src="/src/assets/images/shape-12.svg" alt="Shape" class="h p s" />
      <img src="/src/assets/images/shape-13.svg" alt="Shape" class="h r q" />
      ...
      <div class="tc wf xf jb og">
        ...
        <button class="i rg gm">
          ...
          <div class="h vc wf xf ge jd cl jl ml mf hh rg yk ea fa"></div>
        </button>
        ...
        <div class="wc qf pn xo jg">
          <template x-for="(plan, i) in plans" x-key="i">
            ...
            <div class="animate_top rj sg hh sm vk xm hi nj oj">
              ...
              <!-- Button -->
              <a href="#" class="ek rg lk ml il gi ri"> Try for free </a>
    ...
    <section class="pg pj vp mr oj wp nr">
      ...
      <div class="bb ze ki xn 2xl:ud-px-0 jb" x-data="{filterTab: 1}">
        ...
        <div class="projects-tab _e bb tc uf wf xf cg rg hh rm vk xm si ti fc">
          <button data-filter="*" class="project-tab-btn ek rg ml il vi mi">
            All
          </button>
          <button
        ...
        <div class="projects-wrapper tc -ud-mx-5">
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="/src/assets/images/project-01.png" alt="Project" />
          ...
          <div class="project-item wi fb vd jn/2 to/3 digital">
            <div class="c i pg sg z-1">
              <img src="/src/assets/images/project-02.png" alt="Project" />
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="/src/assets/images/project-04.png" alt="Project" />
          ...
          <div class="project-item wi fb vd vo/3 digital ecommerce">
            <div class="c i pg sg z-1">
              <img src="/src/assets/images/project-03.png" alt="Project" />
                  ...
                  <div class="tc sf rn tn un zf dp">
                    ...
                    <div>
                      ...
                      <div class="tc yf vf">
                        ...
                        <img
                          class="rk"
                          src="/src/assets/images/brand-light-02.svg"
                          alt="Brand"
                        />
                      </div>
                    </div>
        ...
        <div class="wc rf qn zf cp kq xf wf">
          <a href="#" class="rc animate_top">
            <img
              ...
              src="/src/assets/images/brand-light-01.svg"
              alt="Clients"
            />
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-01.svg"
              alt="Clients"
            />
          </a>
          <a href="#" class="rc animate_top">
            ...
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-02.svg"
              alt="Clients"
            />
          </a>
          <a href="#" class="rc animate_top">
            <img
              class="tk ml il zl om"
              src="/src/assets/images/brand-light-03.svg"
              alt="Clients"
            />
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-03.svg"
              alt="Clients"
            />
          </a>
          <a href="#" class="rc animate_top">
            <img
              class="tk ml il zl om"
              src="/src/assets/images/brand-light-04.svg"
              alt="Clients"
            />
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-04.svg"
              alt="Clients"
            />
          </a>
          <a href="#" class="rc animate_top">
            <img
              class="tk ml il zl om"
              src="/src/assets/images/brand-light-05.svg"
              alt="Clients"
            />
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-05.svg"
              alt="Clients"
            />
          </a>
          <a href="#" class="rc animate_top">
            <img
              class="tk ml il zl om"
              src="/src/assets/images/brand-light-06.svg"
              alt="Clients"
            />
            <img
              class="xc sk ml il zl nm"
              src="/src/assets/images/brand-dark-06.svg"
              alt="Clients"
            />
          </a>
        </div>
          ...
          <div class="animate_top sg vk rm xm">
            ...
            <div class="yh">
              <div class="tc uf wf ag jq">
                ...
                <div class="tc wf ag">
                  <img
                    src="/src/assets/images/icon-calender.svg"
                    alt="Calender"
                  />
                  <p>25 Dec, 2025</p>
                </div>
      ...
      <div class="i va bb ye ki xn wq jb mo">
        <div class="tc uf sn tf rn un zf xl:gap-10">
          <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
            ...
            />
            <img
              src="/src/assets/images/shape-06.svg"
              alt="Shape"
              class="h la ma ne kf"
            />
    ...
    <section class="i pg gh ji">
      <!-- Bg Shape -->
      <img class="h p q" src="/src/assets/images/shape-16.svg" alt="Bg Shape" />
