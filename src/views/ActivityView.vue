    ...
    <section class="container mx-auto h-full w-full">
      ...
      >
        ...
        <va-card-content>
          ...
          <p>  Time booked: {{ dayjs(booking.reservation_timestamp * 1000).format("DD/MM/YYYY HH:mm:ss") }} </p>
          <div class="self-end flex justify-center">
              <generic-button titleColor="text-white" bgColor="bg-primary" @click="cancelBooking($event, booking.place_id)">
                  Cancel Booking
              </generic-button>
          </div>
        </va-card-content>
