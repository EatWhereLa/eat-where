...
const renderCharts = (votingSessions) => {
  votingSessions.forEach((session, index) => {
    ...
    svg.selectAll(".winnerLabel")
      .data(data)
      .enter().filter(d => d.upvotes === maxUpvotes)
      .append("text")
      ...
      <div class="bb ye ki xn vq jb jo">
        ...
        <div class="flex items-center justify-between">
          <div class="flex mt-8 items-center">
            ...
            <select
              ...
              v-model="filterValue">
              <option class="border-none" :value="ActivityType.BOOKINGS">Bookings</option>
              <option class="border-none" :value="ActivityType.GROUPVOTE">Group Votes</option>
            </select>
          </div>
          ...
          <div class="wc qf pn xo zf iq">
            <div v-for="activity in activities"
              ...
              <div
                ...
                <img :src=activity.imgSrc class="h-full object-cover w-full" alt="ui/ux review check" />
                <div
              ...
              <div class="p-6">
                ...
                <div class="block font-sans text-base antialiased font-light leading-relaxed text-gray-700">
        ...
        <div v-if="filterValue == ActivityType.GROUPVOTE">
          <div class="wc qf pn xo zf iq">
            ...
            <div v-for="(session, index) in pastVotingResults" :key="index"
              class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
              <div class="text-center pt-4 pd-2 font-medium  text-xl">Voting Result</div>
              <div
                ...
                <div :id="'d3-container-' + index" class="h-full object-cover w-full chart-container"></div>
                <div
        ...
        <div class="mb lo bq i ua">
          <nav>
            <ul class="tc wf xf bg">
              <li>
                <a class="hover:bg-orange-500 c tc wf xf wd in zc hn rg uj fo wk xm ml il hh rm tl zm yl an" href="#">
