...
<template>
  ...
  <main>
    ...
    <div class="flex flex-wrap mt-20 justify-center" style="min-width: 650px;">
            <div class="container lg:w-4/6 xl:w-4/7 sm:w-full md:w-2/3  bg-white  shadow-lg    transform   duration-200 easy-in-out">
        ...
        <div class=" container lg:w-4/6 xl:w-4/7 sm:w-full md:w-2/3 transform   duration-200 easy-in-out">
        

            <div class="col-span-12 overflow-hidden rounded-xl bg-gray-50 px-8 sm:shadow " style="min-width: 650px;">
            <div class="pt-4">
            ...
            <p class="py-2 text-xl font-semibold mb-2">Change Profile Picture</p>
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" >
                    <div class="flex items-center space-x-6">
                        <div class="shrink-0">
                            <img class="h-16 w-16 object-cover rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="Current profile photo" />
                        </div>
                        <label class="block">
                    ...
                    <div class="ml-auto mt-4">
                                <button class="rounded-lg bg-orange-500 px-4 py-2 text-white inline-flex">Change</button>
                            </div>
                </div>
            <hr class="mt-4 mb-8" />
        ...
        <div class=" container lg:w-4/6 xl:w-4/7 sm:w-full md:w-2/3 transform   duration-200 easy-in-out">
            ...
            <p class="py-2 text-xl font-semibold mb-2">Change Profile Picture</p>
                <!-- <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" >
                    ...
                    <select class="border border-orange-500 rounded-full text-orange-500 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                        <option>Set default vote duration</option>
                        <option value="1">1:00 min</option>
                        <option value="2">2:00 min</option>
                        <option value="3">3:00 min</option>
                        <option value="4">4:00 min</option>
                        <option value="5">5:00 min</option>
