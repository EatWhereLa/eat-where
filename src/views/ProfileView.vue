...
<template>
  ...
  <main>
    ...
    <!-- <div class="mx-auto mt-20 pt-10 border-gray-200 dark:border-gray-700   container lg:w-4/6 xl:w-4/7 sm:w-full md:w-2/3">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li class="mr-2">
            <a href="#" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-300 hover:border-gray-300 dark:hover:text-gray-300 group">
                <svg class="w-4 h-4 mr-2 text-black-400 group-hover:text-gray-300 dark:text-gray-500 dark:group-hover:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="flex flex-wrap mt-20 justify-center">
      ...
      >
        ...
        <div
          class="col-span-12 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow"
        >
          <div class="pt-4">
