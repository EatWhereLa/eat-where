...
<template>
    ...
    <main>
        <!-- ===== SignIn Form Start ===== -->
        <section class="i pg fh rm ki xn vq hj rp h bg-white">
            <!-- Bg Shapes -->
            <!-- <img src="../assets/images/shape-06.svg" alt="Shape" class="h j k" />
            <img src="../assets/images/shape-03.svg" alt="Shape" class="h l m" />
            <img src="../assets/images/shape-17.svg" alt="Shape" class="h n o" />
            ...
            <div class="flex items-center justify-center">
                <!-- Bg Border -->
                <div
                    class="relative flex w-full max-h-[43rem]  max-w-[85rem] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                    <div
                    ...
                    <div class="p-6 lg:w-2/5 w-full">
                        ...
                        <h3 class="hk yj kk wm ob mc text-center">Sign in with Social Media</h3>
                        <ul class="tc wf xf mg ec">
                            <li>
